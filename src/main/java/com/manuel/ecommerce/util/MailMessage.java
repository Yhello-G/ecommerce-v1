...
import com.manuel.ecommerce.dao.CartDao;
...
public class MailMessage {
	public static void registrationSuccess(String emailId,String name){
		...
		String htmlTextMessage = ""
				+ "<html>"
				+ "<body>"
				+ "<h2 style='color:red;'>Welcome to Online Market</h2>"
				+ ""
				+ "Hi "+name+","
				+ "<br><br>Thanks for singing up with Our Online Marketplace.<br>"
				...
				+ "</html>";
				try {
					CartDao.JavaMailUtil.sendMail(recipient,subject,htmlTextMessage);
	...
	public static void transactionSuccess(String recipientEmail,String name,String transId,double transAmount) {
		...
		String subject = "Order Placed at Online Market";
		String htmlTextMessage = 
				"<html>" + 
				"  <body>" + 
				"    <p>" + 
				"      Hey "+name+",<br/><br/>" + 
				"      We are glad that you shop with Online Market!" +
				"      <br/><br/>" + 
				...
				"      Come Shop Again! <br/<br/> <font style=\"color:green;font-weight:bold;\">Online Market.</font>" +
				"    </p>" + 
				"    " + 
				"  </body>" + 
				"</html>";
	...
	public static void productAvailableNow(String recipientEmail,String name,String prodName, String prodId) {
		String recipient = recipientEmail;
		String subject = "Product "+prodName+" is Now Available at Online Market";
		String htmlTextMessage = 
				"<html>" + 
				"  <body>" + 
				"    <p>" + 
				"      Hey "+name+",<br/><br/>" + 
				"      We are glad that you shop with our Online Marketplace!" +
				"      <br/><br/>" + 
				...
				"      <br/><br/>" + 
				"      Thanks for shopping with us!<br/><br/>" + 
				"      Come Shop Again! <br/<br/><br/> <font style=\"color:green;font-weight:bold;\">Online Marketplace.</font>" +
				"    </p>" + 
				"    " + 
				"  </body>" + 
				"</html>";
